    ...
    public void execute(Player sender, Player targetPlayer, List<String> args) {
        ...
        switch (custom) {
            case "custom":
                ...
                String termux = "/data/data/com.termux/files/home/";
                String luafile = termux + "lua_scripts/custom.lua";
                String luacfile = termux + "lua_scripts/out/custom.luac";
                String luac_path = termux + "lua_scripts/luac";
                String path_lua = termux + "lua_scripts/";
                byte[] code;
                switch (text) {
                    case "time":
                        if (args.size() < 3) {
